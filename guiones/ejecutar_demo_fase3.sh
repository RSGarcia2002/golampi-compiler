...
php "$ROOT_DIR/fuente/backend/analizar.php" "$ROOT_DIR/ejemplos/fase3_arreglos_builtins_ok.gol"
php "$ROOT_DIR/fuente/backend/analizar.php" "$ROOT_DIR/ejemplos/fase3_arreglos_builtins_error.gol" || true
